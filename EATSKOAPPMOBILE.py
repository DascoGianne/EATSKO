...
def navigationFunction():
    ...
    #CLOSE NAVIGATION AND LOGIN PAGE
    def collapseLogout():
        navigatorMenuFrame.destroy()
...
def loginfunction():
    ...
    #checks if username and password is in json
...
def createfunction():
    ...
    with open('data.json', 'r') as f:
        ...
        #checking if characters are atleast five
        ...
        #create if characters are atleast five
...
meals1_categoriesImageSearch.grid(row = 0, column = 3, padx = (30,5), pady=(0,10) ,  sticky = 'e')
...
meals3_categoriesImageSearch.grid(row = 1, column = 3, padx = (30,5), pady=(0,10) , sticky = 'e')
...
meals5_categoriesImageSearch.grid(row = 2, column = 3, padx = (30,5), pady=(0,10) , sticky = 'e')
...
meals7_categoriesImageSearch.grid(row = 3, column = 3, padx = (30,5), pady=(0,10) ,sticky = 'e')
...
meals9_categoriesImageResize = meals9ImagePath.resize((200,200)) #480x270 #520x310
...
meals9_categoriesImageSearch.grid(row = 4, column = 3, padx = (30,5), pady = (0,10),  sticky = 'e')

meals10_categoriesImageResize = meals10ImagePath.resize((200,200)) #480x270
...
meals10_categoriesImageSearch.grid(row = 5, column = 2, padx = (30,0), pady = (0,10),  sticky = 'e')

meals11_categoriesImageResize = meals11ImagePath.resize((200,200)) #480x270
...
meals11_categoriesImageSearch.grid(row = 5, column = 3, padx = (30,5), pady = (0,10),  sticky = 'e')
...
#pictures of dessert
dessert_categoriesImageResize = dessertImagePath.resize((200,200)) #480x270
...
dessert1_categoriesImageResize = dessert1ImagePath.resize((200,200))
...
dessert1_categoriesImageSearch.grid(row = 0, column = 3, padx = (30,0), pady=(0,10) , sticky = 'w')

dessert2_categoriesImageResize = dessert2ImagePath.resize((200,200))
...
dessert2_categoriesImageSearch.grid(row = 1, column = 2, padx = (30,0), pady=(0,10) , sticky = 'w')

dessert3_categoriesImageResize = dessert3ImagePath.resize((200,200))
...
dessert3_categoriesImageSearch.grid(row = 1, column = 3, padx = (30,0), pady=(0,10) , sticky = 'w')
...
dessert4_categoriesImageSearch.grid(row = 2, column = 2, padx = (30,0), pady = (0,0),  sticky = 'w')
...
dessert5_categoriesImageSearch.grid(row = 2, column = 3, padx = (30,0), pady = (0,0),  sticky = 'e')
...
# SCROLLBAR
storesScrollbar = ctk.CTkScrollableFrame(store_page, width=500, height=700, corner_radius=0, fg_color='white')
storesScrollbar.place(x=0, y=0, relwidth=1, relheight=1)

#stores label
labelStore = Label(storesScrollbar, text="Stores ")
labelStore.config(font=('Shrikhand', 40, 'bold', 'italic'))
labelStore.config(fg='#7d1418', bg='white')
labelStore.grid(row=1, column=0, pady=(80, 0), padx=(130,0))

#cuadro de j button
cdjCategory = Image.open("images/CUADRO DE J.png")
cdjResized = cdjCategory.resize((200,200))
cdjButton = ImageTk.PhotoImage(cdjResized)
cdjPicture = Button(storesScrollbar, text="Button", image=cdjButton, bd=0,
                    highlightthickness=0, bg='white', command=lambda: cuadroFunction())
cdjPicture.grid(row=3, column=0, pady=(50, 0), padx=(120,0))

#cuadro de j rating
cdjratingImagePath = Image.open("images/RAtING STARS/1.png")
cdjratingImageResized = ImageTk.PhotoImage(cdjratingImagePath)
cdjratingImageSearch = Label(storesScrollbar, image=cdjratingImageResized, bd = 0,highlightthickness=0)
cdjratingImageSearch.place(x=150,y=410)

#david's wing button
dwCategory = Image.open("images/DAVIDS WINGS.png")
dwResized = dwCategory.resize((200,200))
dwButton = ImageTk.PhotoImage(dwResized)
dwPicture = Button(storesScrollbar, text="Button", image=dwButton, bd=0,
                   highlightthickness=0, bg='white', command=lambda: davidFunction())
dwPicture.grid(row=4, column=0, pady=(50, 0), padx=(120,0))

#david wings rating
dwImagePath = Image.open("images/RAtING STARS/2.png")
dwImageResized = ImageTk.PhotoImage(dwImagePath)
dwImageSearch = Label(storesScrollbar, image=dwImageResized, bd = 0,highlightthickness=0)
dwImageSearch.place(x=150,y=660)

#koficcino button
koffiCategory = Image.open("images/KOFICCINO.png")
koffiResized = koffiCategory.resize((200,200))
koffiButton = ImageTk.PhotoImage(koffiResized)
koffiPicture = Button(storesScrollbar, text="Button", image=koffiButton, bd=0,
                      highlightthickness=0, bg='white', command=lambda: koffiFunction())
koffiPicture.grid(row=5, column=0, pady=(50, 0), padx=(120,0))

#koficcino rating
kofiImagePath = Image.open("images/RAtING STARS/3.png")
kofiImageResized = ImageTk.PhotoImage(kofiImagePath)
kofiImageSearch = Label(storesScrollbar, image=kofiImageResized, bd = 0,highlightthickness=0)
kofiImageSearch.place(x=150,y=910)

#waffle time button
waffleCategory = Image.open("images/WAFFLE TIME.png")
waffleResized = waffleCategory.resize((200,200))
waffleButton = ImageTk.PhotoImage(waffleResized)
wafflePicture = Button(storesScrollbar, text="Button", image=waffleButton, bd=0,
                       highlightthickness=0, bg='white', command=lambda: waffleFunction())
wafflePicture.grid(row=6, column=0, pady=(50, 0), padx=(120,0))

#waffle time rating
waffletImagePath = Image.open("images/RAtING STARS/4.png")
waffletImageResized = ImageTk.PhotoImage(waffletImagePath)
waffletImageSearch = Label(storesScrollbar, image=waffletImageResized, bd = 0,highlightthickness=0)
waffletImageSearch.place(x=150,y=1160)

#yummy burgers button
yummyCategory = Image.open("images/YUMMY BURGERS.png")
yummyResized = yummyCategory.resize((200,200))
yummyButton = ImageTk.PhotoImage(yummyResized)
yummyPicture = Button(storesScrollbar, text="Button", image=yummyButton, bd=0,
                      highlightthickness=0, bg='white', command=lambda: yummybFunction())
yummyPicture.grid(row=7, column=0, pady=(50, 0), padx=(120,0))

#yummy burgers rating
yummybImagePath = Image.open("images/RAtING STARS/4.png")
yummybImageResized = ImageTk.PhotoImage(yummybImagePath)
yummybImageSearch = Label(storesScrollbar, image=yummybImageResized, bd = 0,highlightthickness=0)
yummybImageSearch.place(x=150,y=1400)

#white space
white = Label(storesScrollbar,text="")
white.config(font = ('Shrikhand',14,'bold','italic'))
white.config(fg = ('white'))
white.config(bg = 'white')
white.grid(row=8, column=0, padx=(300,0))
...
#clear
clearCartB = Button(cart_page, text="Clear", bd=0, font=('Shrikhand', 13, 'bold'),
...
mealsImageResize = mealsImagePathbox.resize((120, 120))
...
meals1ImageResize = meals1ImagePathbox.resize((120, 120))
...
meals2ImageResize = meals2ImagePathbox.resize((120, 120))
...
meals3ImageResize = meals3ImagePathbox.resize((120, 120))
...
meals4ImageResize = meals4ImagePathbox.resize((120, 120))
...
meals5ImageResize = meals5ImagePathbox.resize((120, 120))
...
meals6ImageResize = meals6ImagePathbox.resize((120, 120))
...
meals7ImageResize = meals7ImagePathbox.resize((120, 120))
...
meals8ImageResize = meals8ImagePathbox.resize((120, 120))
...
snacksImageResize = snacksImagePathbox.resize((120, 120))
...
snacks1ImageResize = snacks1ImagePathbox.resize((120, 120))
...
snacks2ImageResize = snacks2ImagePathbox.resize((120, 120))
...
snacks3ImageResize = snacks3ImagePathbox.resize((120, 120))
...
snacks4ImageResize = snacks4ImagePathbox.resize((120, 120))
...
snacks5ImageResize = snacks5ImagePathbox.resize((120, 120))
...
snacks6ImageResize = snacks6ImagePathbox.resize((120, 120))
...
snacks7ImageResize = snacks7ImagePathbox.resize((120, 120))
...
snacks8ImageResize = snacks8ImagePathbox.resize((120, 120))
...
snacks9ImageResize = snacks9ImagePathbox.resize((120, 120))
...
snacks10ImageResize = snacks10ImagePathbox.resize((120, 120))
...
snacks11ImageResize = snacks11ImagePathbox.resize((120, 120))
...
snacks12ImageResize = snacks12ImagePathbox.resize((120, 120))
...
snacks13ImageResize = snacks13ImagePathbox.resize((120, 120))
...
snacks14ImageResize = snacks14ImagePathbox.resize((120, 120))
...
snacks15ImageResize = snacks15ImagePathbox.resize((120, 120))
...
snacks16ImageResize = snacks16ImagePathbox.resize((120, 120))
...
snacks17ImageResize = snacks17ImagePathbox.resize((120, 120))
...
snacks18ImageResize = snacks18ImagePathbox.resize((120, 120))
...
snacks19ImageResize = snacks19ImagePathbox.resize((120, 120))
...
snacks20ImageResize = snacks20ImagePathbox.resize((120, 120))
...
snacks21ImageResize = snacks21ImagePathbox.resize((120, 120))
...
snacks22ImageResize = snacks22ImagePathbox.resize((120, 120))
...
snacks23ImageResize = snacks23ImagePathbox.resize((120, 120))
...
snacks24ImageResize = snacks24ImagePathbox.resize((120, 120))
...
snacks25ImageResize = snacks25ImagePathbox.resize((120, 120))
...
snacks26ImageResize = snacks26ImagePathbox.resize((120, 120))
...
snacks27ImageResize = snacks27ImagePathbox.resize((120, 120))
...
snacks28ImageResize = snacks28ImagePathbox.resize((120, 120))
...
snacks29ImageResize = snacks29ImagePathbox.resize((120, 120))
...
snacks30ImageResize = snacks30ImagePathbox.resize((120, 120))
...
drinksImageResize = drinksImagePathbox.resize((120, 120))
...
drinks1ImageResize = drinks1ImagePathbox.resize((120, 120))
...
drinks2ImageResize = drinks2ImagePathbox.resize((120, 120))
...
drinks3ImageResize = drinks3ImagePathbox.resize((120, 120))
...
drinks4ImageResize = drinks4ImagePathbox.resize((120, 120))
...
drinks5ImageResize = drinks5ImagePathbox.resize((120, 120))
...
drinks6ImageResize = drinks6ImagePathbox.resize((120, 120))
...
drinks7ImageResize = drinks7ImagePathbox.resize((120, 120))
...
drinks8ImageResize = drinks8ImagePathbox.resize((120, 120))
...
drinks9ImageResize = drinks9ImagePathbox.resize((120, 120))
...
drinks10ImageResize = drinks10ImagePathbox.resize((120, 120))
...
drinks11ImageResize = drinks11ImagePathbox.resize((120, 120))
...
drinks12ImageResize = drinks12ImagePathbox.resize((120, 120))
...
dessertImageResize = dessertImagePathbox.resize((120,120)) #480x270
...
dessert1ImageResize = dessert1ImagePathbox.resize((120,120))
...
dessert2ImageResize = dessert2ImagePathbox.resize((120,120))
...
dessert3ImageResize = dessert3ImagePathbox.resize((120,120))
...
meals9ImageResize = meals9ImagePathbox.resize((120,120)) #480x270 #520x310
...
meals10ImageResize = meals10ImagePathbox.resize((120,120)) #480x270
...
meals11ImageResize = meals11ImagePathbox.resize((120,120)) #480x270
...
dessert4ImageResize = dessert4ImagePathbox.resize((120,120))
...
dessert5ImageResize = dessert5ImagePathbox.resize((120,120))
...
meals3ImageSearch.grid(row=1, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

meals4ImageSearch.grid(row=2, column=2, padx=(100, 0), pady=(30, 0), sticky='w')
meals5ImageSearch.grid(row=2, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

meals6ImageSearch.grid(row=3, column=2, padx=(100, 0), pady=(30, 0), sticky='w')
meals7ImageSearch.grid(row=3, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

meals8ImageSearch.grid(row=4, column=2, padx=(100, 0), pady=(30, 0), sticky='w')
snacksImageSearch.grid(row=4, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

snacks1ImageSearch.grid(row=5, column=2, padx=(100, 0), pady=(30, 0), sticky='w')
snacks2ImageSearch.grid(row=5, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

snacks3ImageSearch.grid(row=6, column=2, padx=(100, 0), pady=(30, 0), sticky='w')
snacks4ImageSearch.grid(row=6, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

snacks5ImageSearch.grid(row=7, column=2, padx=(100, 0), pady=(30, 0), sticky='w')
snacks6ImageSearch.grid(row=7, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

snacks7ImageSearch.grid(row=8, column=2, padx=(100, 0), pady=(30, 0), sticky='w')
snacks8ImageSearch.grid(row=8, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

snacks9ImageSearch.grid(row=9, column=2, padx=(100, 0), pady=(30, 0), sticky='w')
snacks10ImageSearch.grid(row=9, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

snacks11ImageSearch.grid(row=10, column=2, padx=(100, 0), pady=(30, 0), sticky='w')
snacks12ImageSearch.grid(row=10, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

snacks13ImageSearch.grid(row=11, column=2, padx=(100, 0), pady=(30, 0), sticky='w')
snacks14ImageSearch.grid(row=11, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

snacks15ImageSearch.grid(row=12, column=2, padx=(100, 0), pady=(30, 0), sticky='w')
snacks16ImageSearch.grid(row=12, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

snacks17ImageSearch.grid(row=13, column=2, padx=(100, 0), pady=(30, 0), sticky='w')
snacks18ImageSearch.grid(row=13, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

snacks19ImageSearch.grid(row=14, column=2, padx=(100, 0), pady=(30, 0), sticky='w')
snacks20ImageSearch.grid(row=14, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

snacks21ImageSearch.grid(row=15, column=2, padx=(100, 0), pady=(30, 0), sticky='w')
snacks22ImageSearch.grid(row=15, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

snacks23ImageSearch.grid(row=16, column=2, padx=(100, 0), pady=(30, 0), sticky='w')
snacks24ImageSearch.grid(row=16, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

snacks25ImageSearch.grid(row=16, column=2, padx=(100, 0), pady=(30, 0), sticky='w')
snacks26ImageSearch.grid(row=16, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

snacks27ImageSearch.grid(row=17, column=2, padx=(100, 0), pady=(30, 0), sticky='w')
snacks28ImageSearch.grid(row=17, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

snacks29ImageSearch.grid(row=18, column=2, padx=(100, 0), pady=(30, 0), sticky='w')
snacks30ImageSearch.grid(row=18, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

drinksImageSearch.grid(row=19, column=2, padx=(100, 0), pady=(30, 0), sticky='w')
drinks1ImageSearch.grid(row=19, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

drinks2ImageSearch.grid(row=20, column=2, padx=(100, 0), pady=(30, 0), sticky='w')
drinks3ImageSearch.grid(row=20, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

drinks4ImageSearch.grid(row=21, column=2, padx=(100, 0), pady=(30, 0), sticky='w')
drinks5ImageSearch.grid(row=21, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

drinks6ImageSearch.grid(row=22, column=2, padx=(100, 0), pady=(30, 0), sticky='w')
drinks7ImageSearch.grid(row=22, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

drinks8ImageSearch.grid(row=23, column=2, padx=(100, 0), pady=(30, 0), sticky='w')
drinks9ImageSearch.grid(row=23, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

drinks10ImageSearch.grid(row=24, column=2, padx=(100, 0), pady=(30, 0), sticky='w')
drinks11ImageSearch.grid(row=24, column=3, padx=(40, 120), pady=(30, 0), sticky='e')
...
def userSearching():
    ...
    if searchFood == "":
        ...
        searchForget()
        snacks12ImageSearch.grid(row=0, column=2, padx=(100, 0), pady=(30, 0), sticky='w')
        snacks13ImageSearch.grid(row=0, column=3, padx=(40, 0), pady=(30, 0), sticky='e')

        snacks14ImageSearch.grid(row=1, column=2, padx=(100, 0), pady=(30, 0), sticky='w')
        snacks15ImageSearch.grid(row=1, column=3, padx=(40, 0), pady=(30, 0), sticky='e')

        snacks16ImageSearch.grid(row=2, column=2, padx=(100, 0), pady=(30, 0), sticky='w')
        snacks17ImageSearch.grid(row=2, column=3, padx=(40, 0), pady=(30, 0), sticky='e')

        snacks30ImageSearch.grid(row=3, column=2, padx=(100, 0), pady=(30, 0), sticky='w')

    elif searchFood == "fewa":
        searchForget()
        snacks19ImageSearch.grid(row=0, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
        snacks20ImageSearch.grid(row=0, column=3, padx=(40, 0), pady=(30, 0), sticky='e')

    elif searchFood == "footlong":
        searchForget()
        snacks21ImageSearch.grid(row=0, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
        snacks29ImageSearch.grid(row=0, column=3, padx=(40, 0), pady=(30, 0), sticky='e')

    elif searchFood == "hotdog":
        searchForget()
        snacks18ImageSearch.grid(row=0, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
        ...
        searchForget()
        mealsImageSearch.grid(row=0, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
        meals1ImageSearch.grid(row=0, column=3, padx=(40, 0), pady=(30, 0), sticky='e')
        ...
        searchForget()
        snacksImageSearch.grid(row=0, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
        ...
        searchForget()
        snacks22ImageSearch.grid(row=0, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
        ...
        searchForget()
        snacks28ImageSearch.grid(row=0, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
        snacks29ImageSearch.grid(row=0, column=3, padx=(40, 0), pady=(30, 0), sticky='e')
        ...
        searchForget() 
        snacks24ImageSearch.grid(row=0, column=2, padx=(100, 0), pady=(30, 0), sticky='w')
        snacks25ImageSearch.grid(row=0, column=3, padx=(40, 0), pady=(30, 0), sticky='e')

        meals9ImageSearch.grid(row=1, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
        meals10ImageSearch.grid(row=1, column=3, padx=(40, 0), pady=(30, 0), sticky='e')

        meals11ImageSearch.grid(row=2, column=2, padx=(100, 0), pady=(30, 0), sticky='e')

    elif searchFood == "coffee" or searchFood == "kofi":
        searchForget()
        drinks2ImageSearch.grid(row=0, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
        ...
        drinks11ImageSearch.grid(row=2, column=3, padx=(40, 0), pady=(30, 0), sticky='e')  

    elif searchFood == "frappe":
        searchForget()
        drinks8ImageSearch.grid(row=0, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
        drinks9ImageSearch.grid(row=0, column=2, padx=(100, 0), pady=(30, 0), sticky='e')

    elif searchFood == "tea":
        searchForget()
        drinksImageSearch.grid(row=0, column=2, padx=(100, 0), pady=(30, 0), sticky='e')  
        drinks1ImageSearch.grid(row=0, column=3, padx=(40, 0), pady=(30, 0), sticky='e') 

        drinks6ImageSearch.grid(row=1, column=2, padx=(100, 0), pady=(30, 0), sticky='e')  
        ...
        searchForget()
        drinks3ImageSearch.grid(row=0, column=2, padx=(100, 0), pady=(30, 0), sticky='e')

    elif searchFood == "ice cream" or searchFood == "icecream"  or searchFood == "ice" or searchFood == "cream":
        searchForget()
        dessertImageSearch.grid(row=0, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
        dessert1ImageSearch.grid(row=0, column=3, padx=(40, 0), pady=(30, 0), sticky='e')

        dessert2ImageSearch.grid(row=1, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
        dessert3ImageSearch.grid(row=1, column=3, padx=(40, 0), pady=(30, 0), sticky='e')

        dessert4ImageSearch.grid(row=2, column=2, padx=(100, 0), pady=(30, 0), sticky='w')

    elif searchFood == "yogurt" or searchFood == "yoghurt":
        searchForget()
        dessert5ImageSearch.grid(row=0, column=2, padx=(100, 0), pady=(30, 0), sticky='e')  
        ...
        dessert2ImageSearch.grid(row=1, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
        dessert3ImageSearch.grid(row=1, column=3, padx=(40, 0), pady=(30, 0), sticky='e')
        dessert4ImageSearch.grid(row=2, column=2, padx=(40, 0), pady=(30, 0), sticky='e')
        dessert5ImageSearch.grid(row=2, column=3, padx=(40, 0), pady=(30, 0), sticky='e')

    else:
        searchForget()
        invalid_label.grid(row=0, column=2, padx=(100, 0), pady=(30, 0), sticky='e')

#Functions used to reset image displays or default
def searchReset():
    
    searchForget()
    invalid_label.grid_forget()
    mealsImageSearch.grid(row=0, column=2, padx=(100, 0), sticky='w')
    meals1ImageSearch.grid(row=0, column=3, padx=(40, 120), sticky='w')
    ...
    drinks12ImageSearch.grid(row=25, column=2, padx=(100, 0), pady=(30, 0), sticky='w')
    dessertImageSearch.grid(row=25, column = 3, padx = (40, 120), pady = (30,0), sticky = 'e')

    dessert1ImageSearch.grid(row=26, column = 2, padx = (100, 0), pady = (30,0), sticky = 'w')
    dessert2ImageSearch.grid(row=26, column = 3, padx = (40, 120), pady = (30,0),  sticky = 'e')

    dessert3ImageSearch.grid(row=27, column = 2, padx = (100, 0), pady = (30,0),  sticky = 'w')  
    meals9ImageSearch.grid(row=27, column = 3, padx = (40, 120), pady = (30,0),  sticky = 'e')

    meals10ImageSearch.grid(row=28, column = 2, padx = (100, 0), pady = (30,0),  sticky = 'w')
    meals11ImageSearch.grid(row=28, column = 3, padx = (40, 120), pady = (30,0),  sticky = 'e')

    dessert4ImageSearch.grid(row=29, column = 2, padx = (100, 0), pady = (30,0),  sticky = 'w')
    dessert5ImageSearch.grid(row=29, column = 3, padx = (40, 120), pady = (30,0),  sticky = 'e')
...
def searchFilterLH():
    ...
    snacks24ImageSearch.grid(row=0, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

    snacks22ImageSearch.grid(row=1, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
    snacks12ImageSearch.grid(row=1, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

    snacks4ImageSearch.grid(row=2, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
    snacks2ImageSearch.grid(row=2, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

    snacks11ImageSearch.grid(row=3, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
    dessert4ImageSearch.grid(row=3, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

    snacks5ImageSearch.grid(row=4, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
    snacks18ImageSearch.grid(row=4, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

    snacks1ImageSearch.grid(row=5, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
    snacks3ImageSearch.grid(row=5, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

    snacks7ImageSearch.grid(row=6, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
    snacksImageSearch.grid(row=6, column=3, padx=(40, 120), pady=(30, 0), sticky='e')
    ...
    snacks16ImageSearch.grid(row=8, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

    drinksImageSearch.grid(row=9, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
    drinks2ImageSearch.grid(row=9, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

    drinks4ImageSearch.grid(row=10, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
    drinks6ImageSearch.grid(row=10, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

    dessertImageSearch.grid(row=11, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
    dessert5ImageSearch.grid(row=11, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

    snacks13ImageSearch.grid(row=12, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
    snacks14ImageSearch.grid(row=12, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

    snacks23ImageSearch.grid(row=13, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
    snacks25ImageSearch.grid(row=13, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

    snacks27ImageSearch.grid(row=14, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
    snacks21ImageSearch.grid(row=14, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

    snacks28ImageSearch.grid(row=15, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
    drinks10ImageSearch.grid(row=15, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

    drinks11ImageSearch.grid(row=16, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
    drinks12ImageSearch.grid(row=16, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

    drinks1ImageSearch.grid(row=17, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
    drinks3ImageSearch.grid(row=17, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

    drinks5ImageSearch.grid(row=18, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
    drinks7ImageSearch.grid(row=18, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

    drinks8ImageSearch.grid(row=19, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
    dessert1ImageSearch.grid(row=19, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

    snacks19ImageSearch.grid(row=20, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
    snacks17ImageSearch.grid(row=20, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

    drinks9ImageSearch.grid(row=21, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
    meals9ImageSearch.grid(row=21, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

    mealsImageSearch.grid(row=22, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
    meals1ImageSearch.grid(row=22, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

    meals2ImageSearch.grid(row=23, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
    meals3ImageSearch.grid(row=23, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

    meals4ImageSearch.grid(row=24, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
    meals5ImageSearch.grid(row=24, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

    snacks30ImageSearch.grid(row=25, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
    snacks15ImageSearch.grid(row=25, column=3, padx=(40, 120), pady=(30, 0), sticky='e')
    ...
    meals6ImageSearch.grid(row=27, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

    meals7ImageSearch.grid(row=28, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
    meals8ImageSearch.grid(row=28, column=3, padx=(40, 120), pady=(30, 0), sticky='e')

    dessert3ImageSearch.grid(row=29, column=2, padx=(100, 0), pady=(30, 0), sticky='e')
    snacks29ImageSearch.grid(row=29, column=3, padx=(40, 120), pady=(30, 0), sticky='e')
...
def order_click(number, orderName):
    ...
    if orderName == "mealsImageSearch":
       ...
       drinks8ImageR = drinks8ImagePath.resize((120, 120))
       ...
       drinks8ImageSe.grid(row=a, column=b, padx=(40, 0), pady=(20, 0), sticky='w') 

    elif orderName == "drinks9ImageSearch":
       drinks9ImageR = drinks9ImagePath.resize((120, 120))
       ...
       drinks9ImageSe.grid(row=a, column=b, padx=(40, 0), pady=(20, 0), sticky='w') 

    elif orderName == "drinks10ImageSearch":
       drinks10ImageR = drinks10ImagePath.resize((120, 120))
       ...
       drinks10ImageSe.grid(row=a, column=b, padx=(40, 0), pady=(20, 0), sticky='w') 

    elif orderName == "drinks11ImageSearch":
       drinks11ImageR = drinks11ImagePath.resize((120, 120))
       ...
       drinks11ImageSe.grid(row=a, column=b, padx=(40, 0), pady=(20, 0), sticky='w') 

    elif orderName == "drinks12ImageSearch":
       drinks12ImageR = drinks12ImagePath.resize((120, 120))
       drinks12ImageRe = ImageTk.PhotoImage(drinks12ImageR)
       image_references.append(drinks12ImageRe)
       drinks12ImageSe = Label(cartpageScrollbar, image=drinks12ImageRe, background='white')
       drinks12ImageSe.grid(row=a, column=b, padx=(40, 0), pady=(20, 0), sticky='w') 
